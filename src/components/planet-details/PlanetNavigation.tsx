...
export function PlanetNavigation({ planetNames, currentPlanet }: PlanetNavigationProps) {
  ...
  // Variants d'animation simplifiés pour les performances
  ...
  if (prefersReducedMotion) {
    return (
      <div className="mt-12 p-6 bg-gradient-to-br from-blue-50/60 to-purple-50/60 dark:from-blue-950/20 dark:to-purple-950/20 rounded-xl border border-blue-200/50 dark:border-blue-500/20 backdrop-blur-sm">
